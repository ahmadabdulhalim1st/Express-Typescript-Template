...
import { ApiError, createError } from "@common/utils/ApiError";
import { HTTP_MESSAGES, HTTP_STATUS } from "@common/constants/httpResponse";
...
export const errorHandler = (error: any, req: Request, res: Response, next: NextFunction) => {
  ...
  ApiResponse.failure(res, {
    statusCode: configuredError?.statusCode || HTTP_STATUS.SERVER_ERROR.INTERNAL_SERVER_ERROR,
